...
Provides a better view of the nuget package data returned from a custom nuget server (https://docs.microsoft.com/en-us/nuget/hosting-packages/nuget-server). Eventually will include searching, ordering and filtering.
